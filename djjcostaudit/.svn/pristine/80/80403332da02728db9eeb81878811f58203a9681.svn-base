...
--%>
<table id="info_error" class="table_edit"
       style="height:300px;width: 520px;border: 1px solid #ccc;padding:5px;display: none;">
    <tr>
        <td style="color:red;font-weight: bold;">未导入的考勤人员编号</td>
    </tr>
    <tr>
        <td>
...
<script type="text/javascript">
    $('#file-zh').fileinput({
        theme: 'zh',
        language: 'zh',
        uploadUrl: "/workRegister/attendanceImport", // server upload action
