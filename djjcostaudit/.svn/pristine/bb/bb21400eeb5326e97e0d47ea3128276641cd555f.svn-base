...
public interface WorkProcessApplyService {
	...
	void updLeave(HttpServletRequest request, WorkProcessApply workProcessApply, GlobalResult result,String s)throws Exception;

	void Change(HttpServletRequest request, WorkProcessApply workProcessApply, GlobalResult result)throws Exception;

	void handleTask(HttpServletRequest request, WorkProcessApply workProcessApply, GlobalResult result)throws Exception;

	void handleRepeal(HttpServletRequest request, WorkProcessApply workProcessApply, GlobalResult result)throws Exception;
	...
	void repeal(HttpServletRequest request, WorkProcessApply workProcessApply, GlobalResult result)throws Exception;

	void handleChange(HttpServletRequest request, WorkProcessApply workProcessApply, GlobalResult result)throws Exception;

	void handle(HttpServletRequest request, WorkProcessApply workProcessApply, GlobalResult result)throws Exception;
