...
function contractSearch(){
    top.addTabGrid('合同台账统计表', '/forward_project_contractJsCount');
    var contractCode=$("#contractCode").val();
    var contractName=$("#contractName").val();
    var projectName=$("#projectName").val();
    var partyB=$("#partyB").val();
