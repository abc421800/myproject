...
<div class="text-center" style="margin-top: 10px;">
    ...
    <input type="button" class="btn btn-success" onclick="window.parent.$('#enterpriseDialog').dialog('close');" value="取消">
</div>
</body>
<script>
var myDate = new Date();
...
$(function() {
    ...
    $("#saveBtn").click(function(){
    	 var rows = $('#containProject').datagrid('getSelections');
    	    ...
    	    window.parent.$("#enterpriseId").val(rows[0].id);
    	    window.parent.$("#enterpriseName").val(rows[0].name);
    	    window.parent.$('#enterpriseDialog').dialog('close');
    })
