    ...
    <div class="filter">
        <div class="form-inline">
            ...
            <div class="form-group">
                ...
                <select class="form-control input-sm" id="yaohaoGrade" onchange="searchOrd()" style="width:80px">
            ...
            <div class="form-group">
                ...
                <select class="form-control input-sm" id="yaohaoYear" onchange="searchOrd()" style="width:80px">
