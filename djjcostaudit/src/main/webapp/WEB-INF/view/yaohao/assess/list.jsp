...
<div class="row">
    <div class="filter">
        <div class="form-inline">
            ...
            <div class="form-group">
                <label>考核年份：</label>
                <select class="form-control input-sm" id="year" style="width: 100px" onchange="search()">
...
<div class="row">
    ...
    <div id="tit1">
        <a href="javascript:void(0);" class="easyui-linkbutton" iconCls="icon-add" plain="false" onclick="top.addTabGrid('综合考核单登记', '/assess/toEdit?editFlag=n');">添加综考企业</a>
        <a href="javascript:void(0);" class="easyui-linkbutton" iconCls="icon-add" plain="false" id="addYaohao" onclick="addYaohaoName()" style="display: none;">生成摇号名单</a>
        <a href="javascript:void(0);" class="easyui-linkbutton" iconCls="icon-remove" plain="false" onclick="deleteHandler()" style="visibility: hidden">删除</a>
    </div>
</div>
