                ...
                <div class="row gutters">
                    ...
                    <div class="col-xl-5 col-lg-5 col-md-5 col-sm-3 col-4 menu-right">
                        <ul class="header-actions">
                            ...
                            <li><a href="javascript:void(0)" id="todos"  data-toggle="dropdown" aria-haspopup="true"><i class="icon-shouce blue"></i>
                            <span class="count-label"></span><span class="info-name blue">手册</span> </a>
                              ...
                              <div class="dropdown-menu dropdown-menu-right lg-new" aria-labelledby="help">
                                    <div class="stats-widget-help">
                                        <div id="login-manual">
                                            1.【基础手册】。请&nbsp;
                                            <a href="javascript:void(0);" onclick="uploadSC()" style="color:#4a90e2;">点击下载</a><br>
                                            2.【考勤管理】操作手册。请&nbsp;
                                            <a href="javascript:void(0);" onclick="uploadKQ()" style="color:#4a90e2;">点击下载</a><br>
                                            3.【摇号管理】操作手册。请&nbsp;
                                            <a href="javascript:void(0);" onclick="uploadYH()" style="color:#4a90e2;">点击下载</a><br>
                                            4.【造价咨询管理】操作手册。请&nbsp;
                                            <a href="javascript:void(0);" onclick="uploadZX()" style="color:#4a90e2;">点击下载</a>
                                            5.【项目指标查询】操作手册。请&nbsp;
                                            <a href="javascript:void(0);" onclick="uploadZB()" style="color:#4a90e2;">点击下载</a>
                                        </div>
                                    </div>
                                </div>
...
function uploadKQ(){
	window.location.href = "/costEnterprise/uploadKQ";
}
function uploadYH(){
    window.location.href = "/costEnterprise/uploadYH";
}
function uploadZX(){
    window.location.href = "/costEnterprise/uploadZX";
}
function uploadZB(){
    window.location.href = "/costEnterprise/uploadZB";
}
</script>
</html>