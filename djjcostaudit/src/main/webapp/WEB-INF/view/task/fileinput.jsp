...
$('#file-zh').fileinput({
    theme: 'zh',
    language: 'zh',
    uploadUrl:"/costAttachment/fileUpload?typeId=${param.typeId}&folderId=${param.folderId}&dataType=${param.dataType}", // server upload action
    maxFileCount:6,//最多上传个数
    allowedFileExtensions: ['zip','rar','doc','docx','xls','xlsx','pdf','txt','png','jpg'],//接收的文件后缀
});
