...
<form action="/costProject/exportContractJsList.do" method="post" id="form1">
    <input type="hidden" id="paramValue" value="${param.contractName}">
    ...
    <div class="filter">
        <div class="form-inline">
         	<div class="form-group">
                ...
                <select class="form-control input-sm" onchange="selectSubmit()" id="auditPriceType" name="auditPriceType" style="width: 100px">
...
<script type="text/javascript">
    ...
    function exportDate() {
       // window.location.href = "${path}/costProject/exportContractJsList.do";
        ...
        var projectClassificationId = $("#projectClassificationId").combotree("getValues");
        var projectClassificationIds = projectClassificationId.join(",");
        if (projectClassificationIds == -1) {
            projectClassificationIds = "";
        }
         $("#orgId").val(dep);
         $("#classId").val(projectClassificationIds);
        ...
        if (selections.length == 0) {
            ...
            $.messager.confirm('提示信息', '确认要导出这' + selections.length + '条记录吗？', function (isOk) {
                ...
                for (var i in selections) {
                    projectIds += selections[i].projectId + ",";
                }
