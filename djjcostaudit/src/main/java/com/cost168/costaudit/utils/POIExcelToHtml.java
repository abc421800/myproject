...
/**
 * 
 * ClassName: POIExcelToHtml 
 * @Description: TODO
 * @author lixiang
 * @date 2018-12-10上午11:11:15
 * @Company  广东华联软件科技有限公司
 */
public class POIExcelToHtml {

   
    public static void exceltoHtml(String filePath, final String outPath){
        String htmlExcel=readExcelToHtml(filePath,true);
        FileUtils.writeFile(htmlExcel,outPath);
    }
    ...
    public static String getExcelInfo(Workbook wb, boolean isWithStyle) {
        ...
        for (int rowNum =sheet.getFirstRowNum();rowNum <= lastRowNum; rowNum++) {
            ...
            if (row == null) {
                sb.append("<tr><td style='border:1px solid #d0d7e5'> &nbsp;</td></tr>");
                continue;
            }
            sb.append("<tr>");
            ...
            for (int colNum = 0; colNum < lastColNum; colNum++) {
                ...
                if (cell == null) { 
                    sb.append("<td style='border:1px solid #d0d7e5'>&nbsp;</td>");
                    continue;
                }
